...
const Login = () => {
  ...
  const [isForgotPassword, setIsForgotPassword] = useState(false);  // Estado para manejar el formulario de "Olvidaste tu contraseña"
  const { logIn, sendPasswordReset } = useAuth(); // Funciones del contexto
  ...
  const handleForgotPassword = async (e) => {
    e.preventDefault();
    try {
      await sendPasswordReset(formData.correo);
      Swal.fire({
              ...
              <div className="row g-0">
                <div className="col-lg-6 animate__animated animate__fadeInLeft">
                  <div className="card-body p-md-5 mx-md-4">
                    ...
                    {/* Formulario de Login o Restablecimiento de Contraseña */}
                    {!isForgotPassword ? (
